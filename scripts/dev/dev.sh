...
echo "    Next.js demo:  http://localhost:13000  /  /chain (calls Express → Flask)"
    echo "    Express demo:  http://localhost:13001  /api/hello /api/chain /api/slow /api/error"
...
echo "    Flask demo:    http://localhost:13003  /api/hello /api/slow /api/error"
echo "                   OTEL traces to Coroot + Prometheus scrape: pod :9464/metrics"
